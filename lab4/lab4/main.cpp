    ...
    _In_ LPWSTR, _In_ int nCmdShow)
{
    ...
    g_hMainWindow = CreateWindowW(wc.lpszClassName, L"Лабораторная работа 4 - Куб с текстурой и Skybox",
...
void Render()
{
    ...
    D3D11_VIEWPORT vpView = { 0, 0, (float)g_WindowWidth, (float)g_WindowHeight, 0.0f, 1.0f };
